...
<header>
  ...
  <div class="konteineris">
    ...
    <div class="button-holder">
      ...
      <a class="button" href="about.php"><img class="button-request" src="images/check.png">Padaryk sprendimą</a>
    </div>
  </div>
</header>
...
<div class="row">
  ...
  <div class="col s12 m6 l4 center-align plotis">
    ...
    <h3> Pasakiškas koralų salą Santorinis. </h3>
    ...
    <a class="mygtukas" href=""><img class="button-request" src="images/check.png">Pasirink</a>
  </div>


  <div class="col s12 m6 l4 center-align plotis">
    <img class="responsive-img" src="images/machu-picchu.jpg" alt="">
    <h3>Peru Anduose inkų civilizacijos miestas Maču Pikču</h3>
  ...
  <div class="col s12 m6 l4 center-align plotis">
    ...
    <p>Čia tiesiog būtina aplankyti gražiausius pakrantės miestus - Positaną, Sorentą ir keltu persikelti į vieną gražiausių Europos salų - Kaprį.  Plaukdami nepaprasto grožio pakrante, pamatysite, kur savo atostogas leidžia pasaulio garsenybės! </p>
    <a class="mygtukas" href=""><img class="button-request" src="images/check.png">Pasirink</a>
  </div>
